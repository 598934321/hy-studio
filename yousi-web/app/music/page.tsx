  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ marginBottom: 8 }}>IMG-MUSIC-HERO</div>
          <div style={{ fontSize: 12 }}>音乐品类 Hero 全屏背景</div>
        </div>
      </div>
    </section>
  );
...
function FeatureSection({
  ...
  service: (typeof musicServices)[0];
  index: number;
}) {
      ...
      >
        ...
        <div style={{ order: isEven ? 1 : 2 }}>
          <RevealOnScroll>
            ...
            >
              {service.slug === "commercial-music"
                ? "背景音乐"
                : service.slug === "music-production"
                ? "原创制作"
                : "音效定制"}
            </div>
            <h2
...
function HighlightsSection() {
  const highlights = [
    { number: "3天", label: "最快出稿", description: "AI辅助创作，快速输出初稿" },
    { number: "100+", label: "服务幼儿园", description: "成都及周边地区" },
    { number: "98%", label: "好评率", description: "客户满意度" },
    { number: "永久", label: "商用授权", description: "一次购买，无限使用" },
  ];
...
function TestimonialsSection() {
  const testimonials = [
    {
      content: "效果超出预期！孩子们特别喜欢新的园歌。",
      author: "张园长",
      kindergarten: "成都阳光幼儿园",
    },
    {
      content: "专业又高效，3天就出了初稿，改了两次就定稿了。",
      author: "李园长",
      kindergarten: "成都未来星幼儿园",
    },
    {
      content: "广播体操音效孩子们特别喜欢，每天都要放。",
      author: "王园长",
...
export default function MusicPage() {
  return (
    <>
      ...
      {/* 全宽图片分隔 */}
      <FullBleedImage id="IMG-MUSIC-MID" label="音乐场景全宽图" />
