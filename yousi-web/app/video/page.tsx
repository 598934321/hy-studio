...
import { videoServices } from "@/data/video";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ marginBottom: 8 }}>IMG-VIDEO-HERO</div>
          <div style={{ fontSize: 12 }}>视频品类 Hero 全屏背景</div>
        </div>
      </div>
    </section>
  );
...
function FeatureSection({
  ...
  service: (typeof videoServices)[0];
  index: number;
}) {
      ...
      >
        ...
        <div style={{ order: isEven ? 1 : 2 }}>
          <RevealOnScroll>
            ...
            >
              {service.slug === "corporate-video"
                ? "企业宣传片"
                : service.slug === "product-ad"
                ? "产品广告"
                : "短视频制作"}
            </div>
            <h2
...
function HighlightsSection() {
  const highlights = [
    { number: "200+", label: "视频作品", description: "丰富的行业案例积累" },
    { number: "50+", label: "幼儿园", description: "服务成都及周边地区" },
    { number: "98%", label: "好评率", description: "客户满意度" },
    { number: "4K", label: "超清画质", description: "专业级拍摄制作" },
  ];
...
function TestimonialsSection() {
  const testimonials = [
    {
      content: "宣传片效果太棒了！家长们看了都说专业，报名咨询量明显增加了。",
      author: "张园长",
      kindergarten: "成都阳光幼儿园",
    },
    {
      content: "短视频在抖音上播放量很高，让更多人知道了我们幼儿园。",
      author: "李园长",
      kindergarten: "成都未来星幼儿园",
    },
    {
      content: "4K画质非常清晰，把园区环境拍得很美，家长们都夸好看。",
      author: "王园长",
...
export default function VideoPage() {
  return (
    <>
      ...
      {/* 全宽图片分隔 */}
      <FullBleedImage id="IMG-VIDEO-MID" label="视频制作场景全宽图" />
