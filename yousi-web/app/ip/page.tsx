      ...
      >
        ...
        <div style={{ order: isEven ? 1 : 2 }}>
          <RevealOnScroll>
            ...
            >
              {service.slug === "ip-design"
                ? "IP形象设计"
                : service.slug === "ip-licensing"
                ? "IP授权运营"
                : "衍生品开发"}
            </div>
            <h2
...
function HighlightsSection() {
  const highlights = [
    { number: "50+", label: "IP形象", description: "原创IP形象设计" },
    { number: "100+", label: "衍生品", description: "丰富的衍生品线" },
    { number: "98%", label: "好评率", description: "客户满意度" },
    { number: "永久", label: "授权使用", description: "一次购买，永久授权" },
  ];
...
function TestimonialsSection() {
  const testimonials = [
    {
      content: "IP形象太可爱了！孩子们每天都抱着吉祥物周边不撒手。",
      author: "张园长",
      kindergarten: "成都阳光幼儿园",
    },
    {
      content: "衍生品质量很好，家长们都抢着买，成了我们园的特色。",
      author: "李园长",
      kindergarten: "成都未来星幼儿园",
    },
    {
      content: "从IP设计到授权落地，全程专业高效，品牌形象提升明显。",
      author: "王园长",
